...
//
//            var loggedInStatusChangeHandler: ((Bool) -> Void)?
//
...
//                        UIApplication.shared.keyWindow?.rootViewController?.present(SpotifyManager.loginController(), animated: true, completion: nil)
//                    }
//                    return
//                }
//
